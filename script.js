const produtos = {
  ...
  "7894094593185": { nome: "Azeitonas kg", preco: 30.89, categoria: ["hortifruti", "fiambreria"] },
  ...
  "7893448921903": { nome: "Contra Filé kg", preco: 44.39, categoria: ["carne", "gelados"] },
  "7897000100001": { nome: "Peito de Frango kg", preco: 18.90, categoria: ["carne", "gelados"] },
  "7897001827346": { nome: "Picanha kg", preco: 89.99, categoria: ["carne", "gelados"] },
  "7897012472816": { nome: "Acém/Paleta kg", preco: 27.87, categoria: ["carne", "gelados"] },
  "7897009127482": { nome: "Coxão Mole/Duro kg", preco: 29.98, categoria: ["carne", "gelados"] },
  "7897000128487": { nome: "Filé Mignon kg", preco: 99.99, categoria: ["carne", "gelados"] },
  "7897249014722": { nome: "Peito de Frango kg", preco: 21.99, categoria: ["carne", "gelados"] },
  "7897002094821": { nome: "Coxinha da Asa kg", preco: 26.76, categoria: ["carne", "gelados"] },
  "7897000214821": { nome: "Costelinha Suína kg", preco: 20.91, categoria: ["carne", "gelados"] },
  "7897002427418": { nome: "Bisteca de Lombo kg", preco: 21.90, categoria: ["carne", "gelados"] },
  "7897000213428": { nome: "Pernil Suíno kg", preco: 31.99, categoria: ["carne", "gelados"] },
  "7897000100002": { nome: "Linguiça Toscana kg", preco: 21.50, categoria: ["carne", "gelados"] },
  "7897009054812": { nome: "Presunto Cozido kg", preco: 34.55, categoria: ["carne", "fiambreria", "gelados"] },
  "7897864510249": { nome: "Mortadela kg", preco: 23.75, categoria: ["carne", "fiambreria"] },
  "7890950324985": { nome: "Peito de Peru Defumado kg", preco: 78.99, categoria: ["carne", "fiambreria"] },
  "7894981935812": { nome: "Salame kg", preco: 89.91, categoria: ["carne", "fiambreria"] },
  "7897902849821": { nome: "Bacon kg", preco: 44.65, categoria: ["carne", "fiambreria"] },
  "7897004588129": { nome: "Salsicha kg", preco: 21.50, categoria: ["carne", "fiambreria", "gelados"] },
  "7898000200001": { nome: "Queijo Mussarela kg", preco: 54.40, categoria: ["laticinios", "fiambreria", "gelados"] },
  "7898000200002": { nome: "Iogurte Natural 200g", preco: 3.20, categoria: ["laticinios", "gelados"] },
  ...
  "7891000000011": { nome: "Manteiga com Sal 200g", preco: 11.90, categoria: ["laticinios", "fiambreria", "gelados", "mercearia"] },
  "7891000000012": { nome: "Margarina 500g", preco: 6.80, categoria: ["laticinios", "fiambreria", "gelados", "mercearia"] },
  "7891000000013": { nome: "Creme de Leite 200g", preco: 3.90, categoria: ["laticinios"] },
  "7891000000014": { nome: "Leite Condensado 395g", preco: 6.5, categoria: ["laticinios"] },
  "7891000222222": { nome: "Iogurte Grego", preco: 4.3, categoria: ["laticinios", "gelados"] },
  "7891000000016": { nome: "Bebida Láctea Fermentada 6uni", preco: 7.50, categoria: ["laticinios", "gelados"] },
  "7891000000017": { nome: "Iogurte Líquido 900g", preco: 13.90, categoria: ["laticinios", "gelados"] },
  "7891000000018": { nome: "Queijo Prato Fatiado kg", preco: 62.00, categoria: ["laticinios", "fiambreria", "gelados"] },
  "7891000000019": { nome: "Queijo Minas Frescal 350g", preco: 15.50, categoria: ["laticinios", "fiambreria", "gelados"] },
  "7891000000020": { nome: "Queijo Parmesão kg", preco: 98.0, categoria: ["laticinios", "fiambreria", "gelados"] },
  "7891000222223": { nome: "Queijo Cottage 25g", preco: 12.9, categoria: ["laticinios", "fiambreria", "gelados"] },
  "7891927340124": { nome: "Queijo Provolone kg", preco: 71.63, categoria: ["laticinios", "fiambreria", "gelados"] },
  "7891444444444": { nome: "Requeijão Tradicional 25g", preco: 9.2, categoria: ["laticinios", "gelados"] },
  ...
  "7898132951382": { nome: "Coca Cola Lata 350ml", preco: 2.30, categoria: ["bebidas", "gelados"] },
  "7894900011517": { nome: "Refrigerante Cola 2L", preco: 8.50, categoria: ["bebidas", "gelados"] },
  "7893000340406": { nome: "Achocolatado", preco: 7.90, categoria: ["bebidas"] },
  "7898080640016": { nome: "Água Mineral 1,5L", preco: 2.00, categoria: ["bebidas", "gelados"] },
  "7894905290627": { nome: "Suco de Caixa", preco: 4.30, categoria: ["bebidas"] },
  "7895000500001": { nome: "Cerveja Pilsen Lata 350ml", preco: 3.99, categoria: ["bebidas", "gelados"] },
  "7895000500002": { nome: "Energético 250ml", preco: 6.50, categoria: ["bebidas", "gelados"] },
  "7895021948782": { nome: "Pote de Sorvete 2L", preco: 24.50, categoria: ["gelados"] },
  "7892491202024": { nome: "Picolé de Fruta", preco: 2.25, categoria: ["gelados"] },
  "7895294812911": { nome: "Picolé de Leite/Chocolate", preco: 5.89, categoria: ["gelados"] },
  "7895294024721": { nome: "Picolé Recheado", preco: 10.24, categoria: ["gelados"] },
  "7899049506589": { nome: "Pote de Açaí 2L", preco: 27.80, categoria: ["gelados"] },
  "7895030895258": { nome: "Copo de Açaí Individual", preco: 7.69, categoria: ["gelados"] },
};
...
function calcularTroco() {
  ...
  if (troco < 0) {
    trocoEl.textContent = `Faltam R$ ${Math.abs(troco).toFixed(2)}`;
  } else {
...
function carregarCatalogo() {
  ...
  Object.entries(produtos).forEach(([codigo, p]) => {
    const categoriasProduto = p.categoria || [];

    if (
      categoriaAtual !== "todos" &&
      !categoriasProduto.includes(categoriaAtual)
    ) return;
